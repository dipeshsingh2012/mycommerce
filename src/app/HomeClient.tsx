...
const TESTIMONIALS: TestimonialItem[] = [
  ...
  },
  {
    id: 'review-3',
    quote:
      'Hiljhil Roasters is hands down the best coffee brand out there! I have enjoyed each cup at their cafes and whenever I brew at home with my V60.',
    rating: 5,
...
interface HomeClientProps {
  initialBestsellers: SliderProduct[];
}

export default function HomeClient({ initialBestsellers }: HomeClientProps) {
  const router = useRouter();
  const [clearanceInput, setClearanceInput] = useState<string>('45');
  const [bestsellerProducts] = useState<SliderProduct[]>(initialBestsellers);
  ...
  return (
    <>
      ...
      <div className="space-y-16 py-4">
        ...
        <HeroBanner
          layout="single"
          eyebrow="Hiljhil Roasters & Specialty Cafe • hiljhil.cafe"
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 border-b border-slate-100 pb-6">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-serif font-bold text-slate-900 mt-1">
                Experience Hiljhil Roasters In Person
              </h2>
